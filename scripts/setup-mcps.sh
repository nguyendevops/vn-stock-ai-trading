...
echo ""
echo "Next steps:"
echo "  1. Get vnstock API key: https://vnstocks.com/login"
echo "  2. Copy config/claude-desktop-config-template.json"
echo "     → paste into: %APPDATA%\\Claude\\claude_desktop_config.json (Windows)"
echo "     → paste into: ~/Library/Application Support/Claude/claude_desktop_config.json (Mac)"
echo "  3. Replace <YOUR_USERNAME> and your_api_key_here in the config"
echo "  4. Windows: run scripts/launch-tv-msix.ps1 as Admin to start TradingView"
